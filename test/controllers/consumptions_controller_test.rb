...
class ConsumptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consumption" do
    assert_difference('Consumption.count') do
      post consumptions_url, params: { consumption: { amount: @consumption.amount, animal_group: @consumption.animal_group, batch: @consumption.batch, date: @consumption.date } }
    end
  ...
  test "should update consumption" do
    patch consumption_url(@consumption), params: { consumption: { amount: @consumption.amount, animal_group: @consumption.animal_group, batch: @consumption.batch, date: @consumption.date } }
